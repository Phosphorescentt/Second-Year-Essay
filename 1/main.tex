...
\begin{definition}\label{def:openly disconnected}
  ...
  $B$. Throughout this essay, I will interchange the term \textbf{openly disconnected} with \textbf{disconnected}. % \footnote{Definitions \ref{def:open path}, \ref{def:openly
