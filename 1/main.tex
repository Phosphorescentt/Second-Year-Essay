...
exist in the infinite cases. \todo{Add computational examples of the connectedness as p changes}
...
\begin{definition}\label{def:critical probability}
  Consider an infinite network $N = (V, E)$. The \textbf{critical probability}, denoted $p_c$, is the percolation probabililty such that there exists a $C \subseteq V$ with $|C| = \infty$.
\end{definition}
...
centered cubic lattice}). Notice how none of these results are precise. This is a testament to how hard this problem is.
